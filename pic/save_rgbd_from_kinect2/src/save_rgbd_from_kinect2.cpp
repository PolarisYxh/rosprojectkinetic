...
string filename_rgbdata="/home/yxh/RGBD/rgbdata.txt";
string filename_depthdata="/home/yxh/RGBD/depthdata.txt";
string save_imagedata = "/home/yxh/RGBD/";
    ...
    while(ros::ok())
    {
             ...
             if( successed_flag1&&successed_flag2)
            {
               ...
               // gettimeofday(&time_val,&tz);//us
                ...
                //dep_str =save_imagedata+"depth/"+os_dep.str()+"_8.png";// 输出8位图像目录
                // imwrite(dep_str,depth1);
